                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #444444; text-align:left; line-height: 24px;">
                                                ...
                                                {{$Name}} has requested you to confirm the sum of &#8358;{{$Amount}}.00 as payment to {{$PayeeName}} as {{$Reason}} under {{$Entity}}. <br>
                                                The entities sharing this expense is(are): <br>
                                                - {{$EntitiesShared[0]}} &nbsp; {{$EntitiesShared[1]}} &nbsp; {{$EntitiesShared[2]}} &nbsp; {{$EntitiesShared[3]}} &nbsp; {{$EntitiesShared[4]}} <br>
