                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #444444; text-align:left; line-height: 24px;">
                                                ...
                                                {{$GCOO}} has rejected your expense application of &#8358;{{$Amount}}.
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #016B5A; text-align:left; line-height: 24px;">
                                                Successful Expense Application Notification.
                                             </td>
                                          </tr>
                                          <!-- Spacing -->
                                          <tr>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #444444; text-align:left; line-height: 24px;">
                                                ...
                                                Your expense application scaled through all the approval stages and the sum of &#8358;{{$Amount}} has been paid to {{$PayeeName}}.<br>
                                                &#8358;{{$Tax}} has been deducted as tax. <br>
